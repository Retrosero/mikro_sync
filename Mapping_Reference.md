# Web2ERP Eşleşme Mapping Referansı

Oluşturulma Tarihi: 21.11.2025 14:22:51
...
| satislar | fatura_sira_no | CARI_HESAP_HAREKETLERI | cha_evrakno_sira |  |
| satislar | fatura_seri_no | CARI_HESAP_HAREKETLERI | cha_evrakno_seri |  |
...
| satislar | ara_toplam | CARI_HESAP_HAREKETLERI | cha_aratoplam |  |
| satislar | notlar | CARI_HESAP_HAREKETLERI | cha_aciklama |  |
...
| satislar | indirim_tutari | CARI_HESAP_HAREKETLERI | cha_ft_iskonto1 |  |
| satislar | indirim_tutari2 | CARI_HESAP_HAREKETLERI | cha_ft_iskonto2 |  |
| satislar | indirim_tutari3 | CARI_HESAP_HAREKETLERI | cha_ft_iskonto3 |  |
| satislar | indirim_tutari4 | CARI_HESAP_HAREKETLERI | cha_ft_iskonto4 |  |
| satislar | indirim_tutari5 | CARI_HESAP_HAREKETLERI | cha_ft_iskonto5 |  |
| satislar | indirim_tutari6 | CARI_HESAP_HAREKETLERI | cha_ft_iskonto6 |  |
...
| satis_kalemleri | miktar | STOK_HAREKETLERI | sth_miktar |  |
| satis_kalemleri | indirim_tutari | STOK_HAREKETLERI | sth_iskonto1 |  |
| satis_kalemleri | indirim_tutari2 | STOK_HAREKETLERI | sth_iskonto2 |  |
| satis_kalemleri | indirim_tutari3 | STOK_HAREKETLERI | sth_iskonto3 |  |
| satis_kalemleri | indirim_tutari4 | STOK_HAREKETLERI | sth_iskonto4 |  |
| satis_kalemleri | indirim_tutari5 | STOK_HAREKETLERI | sth_iskonto5 |  |
| satis_kalemleri | indirim_tutari6 | STOK_HAREKETLERI | sth_iskonto6 |  |
| satis_kalemleri | toplam_tutar | STOK_HAREKETLERI | sth_tutar |  |
| satis_kalemleri | kdv_tutari | STOK_HAREKETLERI | sth_vergi |  |
| satis_kalemleri | kdv_orani -> (pointer) | STOK_HAREKETLERI | sth_vergi_pntr | INT_KdvPointerMap: oran→pntr. |
| satislar | satis_tarihi | STOK_HAREKETLERI | sth_tarih; sth_belge_tarih |  |
...
| satislar | fatura_sira_no | CARI_HESAP_HAREKETLERI | sth_evrakno_sira |  |
| satislar | fatura_seri_no | CARI_HESAP_HAREKETLERI | sth_evrakno_seri |  |

## AlanEslesmesi_Tahsilat

| Web Tablo | Web Alan | ERP Tablo | ERP Alan |
| --- | --- | --- | --- |
| tahsilatlar | tahsilat_tarihi | CARI_HESAP_HAREKETLERI | cha_tarihi; cha_belge_tarih |
| tahsilatlar | cari_hesap_id -> (kod) | CARI_HESAP_HAREKETLERI | cha_kod |
| tahsilatlar | tutar | CARI_HESAP_HAREKETLERI | cha_meblag; cha_aratoplam |
| tahsilatlar | aciklama | CARI_HESAP_HAREKETLERI | cha_aciklama |
| tahsilatlar | tahsilat_tipi='nakit' | CARI_HESAP_HAREKETLERI | cha_tpoz=1; cha_cari_cins=4; cha_kod=<kasa_kodu> |
| tahsilatlar | tahsilat_tipi in ('kredi_karti','havale') | CARI_HESAP_HAREKETLERI | cha_tpoz=1; cha_cari_cins=2; cha_kod=<banka_kodu> |
| tahsilatlar | tahsilatlar.cek_no / tahsilatlar.banka_adi / tahsilatlar.sube_adi / tahsilatlar.hesap_no | CARI_HESAP_HAREKETLERI / ODEME_EMIRLERI | cha_aciklama / sck_no, sck_banka_adres1, sck_sube_adres2, sck_hesapno_sehir |
| (konfig) | (—) | CARI_HESAP_HAREKETLERI | cha_evrak_tip; cha_tip; cha_cinsi; cha_normal_iade |
| tahsilatlar | tahsilat_sira_no | CARI_HESAP_HAREKETLERI | cha_evrakno_sira |
| tahsilatlar | tahsilat_seri_no | CARI_HESAP_HAREKETLERI | cha_evrakno_seri |
| tahsilatlar | notlar | CARI_HESAP_HAREKETLERI | cha_aciklama |
| tahsilatlar |  | CARI_HESAP_HAREKETLERI | cha_vade |
...
| satis_fatura | giris |  | Genelde boş; ihtiyaca göre |
