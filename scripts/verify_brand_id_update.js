...
function verifyBrandIdUpdate() {
    try {
        ...
        // Beklenen değer
        if (product.brand_id === 429) {
            console.log('\n✓ TEST BASARILI! brand_id dogru guncellendi (429 - ASYA).');
        } else {
            console.log(`\n❌ brand_id beklenen degerde degil. Mevcut: ${product.brand_id}, Beklenen: 429`);
        }
