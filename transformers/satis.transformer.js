  ...
  async transformSatisBaslik(webSatis) {
    try {
      ...
      return {
        ...
        cha_ft_iskonto2: webSatis.iskonto2 || 0,
        cha_ft_iskonto3: webSatis.iskonto3 || 0,
        cha_ft_iskonto4: webSatis.iskonto4 || 0,
        cha_ft_iskonto5: webSatis.iskonto5 || 0,
        cha_ft_iskonto6: webSatis.iskonto6 || 0,
        cha_evrak_tip: 63,
        cha_tip: 0,
        cha_cinsi: 6,
  ...
  async transformSatisKalem(webKalem, webSatis) {
    try {
      ...
      return {
        ...
        sth_iskonto3: webKalem.iskonto3 || 0,
        sth_iskonto4: webKalem.iskonto4 || 0,
        sth_iskonto5: webKalem.iskonto5 || 0,
        sth_iskonto6: webKalem.iskonto6 || 0,
        ...
        sth_netagirlik: 0,
        sth_odeme_op: 0,
        sth_aciklama: (webKalem.notlar || webSatis.notlar || '').substring(0, 255), // Önce kalem notları, sonra satış notları
